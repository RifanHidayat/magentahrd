...
class RejectedAbsenceAdminPage extends StatefulWidget {
  ...
  @override
  _RejectedAbsenceAdminPageState createState() =>
      _RejectedAbsenceAdminPageState();
}

class _RejectedAbsenceAdminPageState extends State<RejectedAbsenceAdminPage> {
  late Map _absence;
  bool _loading = true;
  ...
  Future _dataAbsence() async {
    try {
      ...
      var absence = _absence_data['data']
          .where((prod) => prod["present"] == "permission")
          .toList();
